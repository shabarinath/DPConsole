...
CREATE TABLE kitchen_discounts (
  ...
  discount DOUBLE(10, 4) NOT NULL DEFAULT 0,
  active BOOLEAN NOT NULL DEFAULT 1,
  PRIMARY KEY (id)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
...
CREATE TABLE orders (
  ...
  total_cost DOUBLE(10, 4) NOT NULL DEFAULT 0,
  post_commission_amount DOUBLE(10, 4) NOT NULL DEFAULT 0,
  dp_received_price DOUBLE(10, 4) NOT NULL DEFAULT 0,
