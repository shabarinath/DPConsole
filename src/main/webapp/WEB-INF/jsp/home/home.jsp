...
<%@ include file="../includes/taglibs.jsp"%> 
  <section id="intro">
    ...
    <div class="container">
      <div class="row">
        <div class="span6">
          <h2><span class="highlight primary">Delivery Partner Console </span></h2>
          <p class="lead">
          ...
          <div class="group section-wrap upper" id="upper">
            <div class="section-2 group">
              <ul id="images" class="rs-slider">
                <li class="group">
                  <a href="#">
				            <img src="/resources/img/slides/refine/slide1.png" alt="" />
				        </a>
                </li>
                <li class="group">
                  <a href="#" class="slide-parent">
				            <img src="/resources/img/slides/refine/slide2.png" alt=""/>
				        </a>
                </li>
                <li class="group">
                  <img src="/resources/img/slides/refine/slide3.png" alt="" />
                </li>
              </ul>
            </div>
            <!-- /.section-2 -->
